package com.rock.hadoop.core.mapreduce.example;
...
public class Q1SumDeptSalary extends Configured implements Tool {
    public static class MapClass extends Mapper<LongWritable, Text, Text, Text> {
        ...
        protected void setup(Context context) {
            ...
            try {
                // 从当前作业中获取要缓存的文件
                URI[] paths = JobContextImpl.getCacheFiles(context.getConfiguration());
    ...
    public int run(String[] args) throws Exception {
        ...
        //会在每个节点上缓存该文件，在进行map或者reduce的时候都可以从缓存中取到这个文件
        Job.addCacheFile(new URI(otherArgs[0]), job.getConfiguration());
    ...
    public static void main(String[] args) throws Exception {
        args=Arrays.asList("conf/dept.txt","conf/emp.txt","conf/out2").toArray(new String[]{});
