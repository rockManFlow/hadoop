...
public class ZipCrackerSpark {
    ...
    public static void main(String[] args) throws ZipException {
        String zipFilePath="/Users/opayc/products/tools/src/main/java/com/kuark/tool/advance/advance20241017/method2/test02.zip";
        String passwordFile="/Users/opayc/products/tools/src/main/java/com/kuark/tool/advance/advance20241017/method2/password_list.txt";
    ...
    public static void crackerZip(String zipFilePath,String passFilePath) throws ZipException {
        ...
        unzip(zipFilePath,lines.toString());
